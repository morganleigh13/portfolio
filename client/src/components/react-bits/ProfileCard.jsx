...
const ProfileCardComponent = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(125, 190, 255, 0.36)',
  ...
  const shineStyle = {
    ...
    filter: 'brightness(0.6) contrast(0.99) saturate(0.33) opacity(0.7)',
  ...
  return (
    ...
    >
      ...
      <div ref={shellRef} className="relative z-1 group">
        ...
        >
            {/* Background color behind picture */}
          <div
          ...
          >
            ...
            >
              <img
                className="w-full min-h-4/5 absolute left-1/2 bottom-0 rounded-xl backface-hidden will-change-transform transition-transform duration-120 ease-out"
                src={avatarUrl}
              ...
              {showUserInfo && (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className="rounded-3xl overflow-hidden border border-white/20 shrink-0"
                    ...
                    >
                      <img
                        ...
                        loading="lazy"
                        style={{ display: 'block', gridArea: 'auto', borderRadius: '10%', pointerEvents: 'auto' }}
                        onError={e => {
                          const t = e.target;
                          t.style.opacity = '0.5';
                          t.src = avatarUrl;
            ...
            >
              <div className="w-full absolute flex flex-col bg-base-100" style={{ top: '1px', display: 'flex', gridArea: 'auto' }}>
                <h3
