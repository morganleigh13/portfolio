  ...
  return (
    ...
    >
      ...
      <div className="relative text-center justify-center flex w-1/3 max-w-5xl">
        <PixelCard>
          <div className="max-w-xl relative z-10 sm:px-10 px-5 pt-3 lg:pt-15 ">
            <h3 className="sm:text-5xl text-4xl font-semibold text-neutral-content bg-base-300 w-fit rounded-4xl px-1 py-1">
              Bring your vision to life—reach out through this form.
            </h3>
            <p className="text-xl text-sky-200 mt-5 bg-base-300 w-fit rounded-4xl px-1 py-1">
            ...
            <form
              ...
              className="mt-8 flex flex-col space-y-1 grow w-full relative"
            >
              ...
              <div className="justify-end flex w-full my-10">
                <button
                  className="bg-base-100 w-1/3 px-5 py-2 min-h-12 rounded-lg shadow-slate-200 shadow-2xl flex justify-center items-center text-lg text-seconary-content gap-3"
                  type="submit"
                  disabled={loading}
                >
                  ...
                  <img
                    src="/mobile.svg"
                    alt="arrow-up"
                    className="bg-secondary px-2 py-2 min-h-12 rounded-lg shadow-slate-200 shadow-2xl flex justify-center items-center text-lg text-primary gap-3_arrow"
                  />
                </button>
              </div>
            </form>
