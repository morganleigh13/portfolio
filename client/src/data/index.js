...
export const experiences = [
  {
    ...
    title: "Mentored 20+ peers from beginning coders into MERN full stack web developers. Co‑authored a comprehensive class wiki that now serves as the go‑to resource for all future students.  Designed a full‑stack Daily‑Check‑In app that earned the “Best Innovation” award during our first ever Hack-a-thon.",
    icon: '/assets/p.svg',
    animation: 'victory',
  },
  {
  ...
  },
  {
    id: 3,
    name: 'Bubbles',
    pos: 'Real‑time Chat with AI',
    duration: '2025',
    title: "Developed a Socket.io chat app where users can talk in real-time to each other. Embedded Ollama‑powered AI responses directly into the chat stream (real‑time, in‑browser inference) in one of the chat rooms. Leveraged JWT authentication and Argon2 hashing for secure, stateless sessions. Delivered a polished UI with Tailwind and DaisyUI.",
  ...
  },
  {
    id: 4,
    name: 'DonorDB',
    pos: 'Donor‑Tracking CRM',
    duration:'2024',
    title: "Built a MongoDB‑backed CRM for a non‑profit, featuring secure CRUD, pagination, and sortable tables. Integrated role‑based access control and server‑side validation to protect sensitive data. Streamlined the workflow with dynamic filtering and export options.Implemented a reusable Argon2‑protected login component shared across all projects.",
